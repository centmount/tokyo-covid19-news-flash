...
def get_death_data():
    global df_string
    url3 = f'https://www.fukushihoken.metro.tokyo.lg.jp/hodo/saishin/corona{max_num + add_num}.html'
...
def sendGmailAttach():
    ...
    sub = '東京都の新型コロナ死亡データ' #メール件名
    body = f'東京都の新型コロナ死亡データを送ります。 \n\n\n {df_string}'  # メール本文
